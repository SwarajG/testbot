module.exports = {
  ...
  combos: [{
    name: 'Single (Serve 1)',
    descriptions: 'Biryani(Regular size) with a roll. Choose when confirming the order on the phone on phone',
    image: 'https://s3-ap-southeast-1.amazonaws.com/upandup-resources/combo.jpeg',
    value: 'single-serve',
    price: 199,
  }, {
    name: 'Up Friends Up (Serve 2)',
    descriptions: 'Biryani(Jumbo size) with a roll. Choose when confirming the order on the phone on phone',
    image: 'https://s3-ap-southeast-1.amazonaws.com/upandup-resources/combo.jpeg',
    value: 'friend-up-serve',
    price: 299,
  }, {
    name: 'Special-Single (Serve 1)',
    descriptions: 'Non veg Biryani(Regular size) with a roll. Choose when confirming the order on the phone on phone',
    image: 'https://s3-ap-southeast-1.amazonaws.com/upandup-resources/combo.jpeg',
    value: 'special-serve',
    price: 249,
  }, {
    name: 'Special-Up Friends Up (Serve 2)',
    descriptions: 'Non veg Biryani(Jumbo size) with a roll. Choose when confirming the order on the phone on phone',
    image: 'https://s3-ap-southeast-1.amazonaws.com/upandup-resources/combo.jpeg',
